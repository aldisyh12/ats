    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a type="button" class="btn btn-default dropdown-toggle waves-effect waves-light" href="{{ route('admin.cabang.create') }}">Buat Cabang </a>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <h4 class="m-t-0 header-title"><b>Daftar Cabang</b></h4>
                ...
                <table id="datatable-responsive"
                    ...
                    @foreach($cabang as $key => $record)
                        <tr>
                            ...
                            <td>
                                @if($record->path != null)
                                    <img src="{{ asset('pekerjaan/'. $record->path) }}" width="100" height="80" />
                                @else
                                    Gambar Kosong
                                @endif
                            </td>
                            ...
                            <td>
                                <form action="{{route('admin.cabang.delete', $record->id)}}" method="POST">
                                    @csrf
                                    <a href="{{ route('admin.cabang.show', $record->id) }}" class="btn btn-sm btn-primary">Ubah</a>
