...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Buat Cabang</h4>
            <ol class="breadcrumb">
                <li>
                    <a href="#">Cabang</a>
                </li>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card-box">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" action="{{ route('admin.cabang.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Nama Cabang</label>
                                <input type="text" class="form-control" name="name" placeholder="Input Nama Cabang" required />
                            </div>
                            <div class="form-group">
                                <label>Alamat Cabang</label>
                                <input type="text" class="form-control" name="alamat" placeholder="Input Alamat Cabang" required />
                            </div>
                            <div class="form-group">
