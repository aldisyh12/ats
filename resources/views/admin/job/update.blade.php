...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Ubah Pekerjaan</h4>
            <ol class="breadcrumb">
                <li>
                    <a href="#">Pekerjaan</a>
                </li>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card-box">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" action="{{ route('admin.job.update', $record->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Judul Pekerjaan</label>
                                <input type="text" class="form-control" name="job_header" placeholder="Input Judul Pekerjaan" value="{{ $record->job_header }}" required />
                            </div>
                            <div class="form-group">
                                <label>Minimal Pengalaman</label>
                                <input type="text" class="form-control" name="job_header" placeholder="Input Pengalaman, Contoh : 2 Tahun" value="{{ $record->pengalaman }}" required />
                            </div>
                            <div class="form-group">
                                <label>Jabatan</label>
                                <input type="text" class="form-control" name="job_header" placeholder="Input Jabatan, Contoh : Fullstack Programmer" value="{{ $record->jabatan }}" required />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="path" class="filestyle" data-buttonname="btn-white" value="{{ $record->images->path }}" required>
                            </div>
