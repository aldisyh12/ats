        ...
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <button class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                        data-target="#con-close-modal">Buat Keahlian
                </button>
            </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                ...
                <h4 class="m-t-0 header-title"><b>Keahlian Pekerjaan</b></h4>
                <p class="text-muted font-13 m-b-30">
                    List keahlian untuk pilihan pekerjaan yang akan diinput.
                </p>
            ...
            <form action="{{ route('admin.skill.store') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Buat Keahlian</h4>
                    </div>
