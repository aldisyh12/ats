...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Ubah Keahlian</h4>
            <ol class="breadcrumb">
                <li>
                    <a href="#">Keahlian Pekerjaan</a>
                </li>
                <li class="active">
                    Ubah Keahlian
                </li>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card-box">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" action="{{ route('admin.skill.update', $record->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control" name="name" value="{{ $record->name }}" placeholder="Input Nama Keahlian" required />
                            </div>
