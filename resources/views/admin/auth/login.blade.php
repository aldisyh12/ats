...
<div class="wrapper-page">
    <div class=" card-box">
        <div class="panel-heading">
            <h3 class="text-center"> Login Ke <strong class="text-custom">Cipta Karsa Karya</strong> </h3>
        </div>
...
{{--                </div>--}}
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-xs-12">
                        <button class="btn btn-pink btn-block text-uppercase waves-effect waves-light" type="submit">Masuk</button>
                    </div>
                </div>
...
{{--                </div>--}}
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <p>Tidak punya akun? <a href="{{ route('user.form.register') }}" class="text-primary m-l-5"><b>Daftar Sekarang</b></a></p>
